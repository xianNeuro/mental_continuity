...
2. **Not on GitHub because of size (9.1 GB)** — the four imaging-matrix
   ...
   `mental_continuity_data_1data_v1.0.zip` from the Zenodo record
   ...
   `mental_continuity_repo_v1.0.zip`, so the record alone reconstructs the
...
After unzipping `mental_continuity_data_1data_v1.0.zip` inside `data/`, this
